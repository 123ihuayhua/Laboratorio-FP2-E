...
import static laboratorio15.Configuracion.Eliminar;
import static laboratorio15.Configuracion.MOdificarSoldado;
import static laboratorio15.Configuracion.RankingEjercito;
import static laboratorio15.Configuracion.RankingSoldado;
import static laboratorio15.VideoJuego.Generacion;
import static laboratorio15.VideoJuego.VideoJuego1;
//import static laboratorio15.VideoJuego.VideoJuego1;
import static laboratorio15.VideoJuego.VideoJuego2;
...
public class Menu {
    ...
    private static void Menu3() {
        ...
        System.out.println("\t[4] RANKING DE PODER SOLDADO");
        System.out.println("\tIngrese una opcion: ");
    ...
    private static void Seleccion3(int opcion3) {
        switch(opcion3){
            ...
            case 3:
                ...
                RankingEjercito();
            case 4:
                System.out.println("\n\t***********RANKING DE PODER SOLDADO***********");
                System.out.println("\n\t-> Se muestra RANKING por NIVEL DE VIDA por SOLDADO <-");
                RankingSoldado();
            default: 
                System.out.println("\tNo existe esa opcion");
                System.out.println("\tIntente de nuevo: ");
