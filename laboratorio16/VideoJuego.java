...
public class VideoJuego {
    ...
    static HashMap<Integer,String> reinos = new HashMap();
    ...
    public static int Reinos_Terr(){
        ...
        //Reinos
        reinos.put(0,"INGLATERRA");
        reinos.put(1,"FRANCIA");
        reinos.put(2,"CASTILLA-ARAGON");
        reinos.put(3,"MOROS");
        reinos.put(4,"SACRO-IMPERIO-ROMANO");
        return reinos.size();
    }
