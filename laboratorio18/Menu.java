...
import static laboratorio18.Configuracion.Eliminar;
import static laboratorio18.Configuracion.MOdificarSoldado;
import static laboratorio18.Configuracion.RankingEjercito;
import static laboratorio18.VideoJuego.Generacion;
import static laboratorio18.VideoJuego.VideoJuego1;
import static laboratorio18.VideoJuego.VideoJuego2;
    ...
    private static void Seleccion2(int opcion2) {
        switch(opcion2){
            case 1: 
                ...
                System.out.println("\n\t -> El ganador se decide por 3 diferentes METRICAS <-");
                //Generacion();
                VideoJuego1();
                break;
            case 2:
