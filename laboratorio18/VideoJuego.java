...
public class VideoJuego {
	...
	do {
            ...
            Ejercito ejercito_ganador2 = batallametri2(ejercito_origen, ejercito_destino);
            System.out.println("\tMETRICA 3: ");
            System.out.println("\t->Ganador respecto a la probabilidad del NIVEL DE DEFENSA<-");
            Ejercito ejercito_ganador3 = batallametri3(ejercito_origen, ejercito_destino);
            System.out.println("");
            //Definiendo ganador por mayor cantidad de métricas
                if ((ejercito_ganador == ejercito_ganador2)) {
                    c.setEjercito(lista_indices_destino.get(0), lista_indices_destino.get(1), ejercito_ganador);
                    System.out.println("\tGANADOR EN 2 METRICAS o + -> " + ejercito_ganador.getReino());
                    System.out.println("\tGANADOR ==== " + ejercito_ganador.getReino()+"\n");
                } else if (ejercito_ganador == ejercito_ganador3) {
                    c.setEjercito(lista_indices_destino.get(0), lista_indices_destino.get(1), ejercito_ganador);
                    System.out.println("\tGANADOR EN 2 METRICAS o + -> " + ejercito_ganador.getReino());
                    System.out.println("\tGANADOR ==== " + ejercito_ganador.getReino()+"\n");
                } else if (ejercito_ganador2 == ejercito_ganador3) {
                    c.setEjercito(lista_indices_destino.get(0), lista_indices_destino.get(1), ejercito_ganador2);
                    System.out.println("\tGANADOR EN 2 METRICAS o + -> " + ejercito_ganador2.getReino());
                    System.out.println("\tGANADOR ==== " + ejercito_ganador2.getReino()+"\n");
                }else{
                    c.setEjercito(lista_indices_destino.get(0), lista_indices_destino.get(1), ejercito_ganador2);
                    System.out.println("\tGANADOR EN 2 METRICAS o + -> " + ejercito_ganador2.getReino()+"\n");
                    System.out.println("\tGANADOR ==== " + ejercito_ganador3.getReino()+"\n");
                } 
    ...
    //Metodo 1 -> Juego Largo -> Nivel Vida
    public static Ejercito batallametr(Ejercito a, Ejercito b) {
        int total = a.sumaNivelVida() + b.sumaNivelVida();
        double p1, p2;
	p1 = a.sumaNivelVida() * 1.0 / total;
	p2 = b.sumaNivelVida() * 1.0 / total;
        System.out.println("\t"+ "Reino: " + a.getReino() + " " + a.getNombre_ejercito() + " NVT: " + a.sumaNivelVida());
	System.out.println("\t"+ "Reino: " + a.getReino() + " " + a.getNombre_ejercito() + " P: " + p1);
        System.out.println("\t"+ "Reino: " + b.getReino() + " " + b.getNombre_ejercito() + " NVT: " + b.sumaNivelVida());
        System.out.println("\t"+ "Reino: " + b.getReino() + " " + b.getNombre_ejercito() + " P: " + p2);
	double aleatorio = r.nextDouble();
        if (aleatorio >= p1) {
            System.out.println("\tALEATORIO: " + aleatorio + " -> " + "" + " GANADOR " + b + "\n");
            System.out.println();
            b.subirNivelVidaEjercito();
            return b;
	} else {
            System.out.println("\tALEATORIO: " + aleatorio + " -> " + "" + " GANADOR " + a + "\n");
            System.out.println();
            a.subirNivelVidaEjercito();
            return a;
        }
    }
    
    //Metrica 2 -> Juego largo -> Nivel Ataque
    public static Ejercito batallametri2(Ejercito a, Ejercito b){
        int total = a.sumaNivelAtaque() + b.sumaNivelAtaque();
        double p1, p2;
	p1 = a.sumaNivelAtaque() * 1.0 / total;
	p2 = b.sumaNivelAtaque() * 1.0 / total;
        System.out.println("\t"+ "Reino: " + a.getReino() + " " + a.getNombre_ejercito() + " NAT: " + a.sumaNivelAtaque());
	System.out.println("\t"+ "Reino: " + a.getReino() + " " + a.getNombre_ejercito() + " P: " + p1);
        System.out.println("\t"+ "Reino: " + b.getReino() + " " + b.getNombre_ejercito() + " NAT: " + b.sumaNivelAtaque());
        System.out.println("\t"+ "Reino: " + b.getReino() + " " + b.getNombre_ejercito() + " P: " + p2);
	double aleatorio = r.nextDouble();
        if (aleatorio >= p1) {
            System.out.println("\tALEATORIO: " + aleatorio + " -> " + "" + " GANADOR " + b + "\n");
    ...
    //Metrica 3 -> Juego Largo -> Nivel Defensa
    public static Ejercito batallametri3(Ejercito a, Ejercito b){
        int total = a.sumaNivelDefensa() + b.sumaNivelDefensa();
        double p1, p2;
	p1 = a.sumaNivelDefensa() * 1.0 / total;
	p2 = b.sumaNivelDefensa() * 1.0 / total;
        System.out.println("\t"+ "Reino: " + a.getReino() + " " + a.getNombre_ejercito() + " NDT: " + a.sumaNivelDefensa());
	System.out.println("\t"+ "Reino: " + a.getReino() + " " + a.getNombre_ejercito() + " P: " + p1);
        System.out.println("\t"+ "Reino: " + b.getReino() + " " + b.getNombre_ejercito() + " NDT: " + b.sumaNivelDefensa());
        System.out.println("\t"+ "Reino: " + b.getReino() + " " + b.getNombre_ejercito() + " P: " + p2);
	double aleatorio = r.nextDouble();
        if (aleatorio >= p1) {
            System.out.println("\tALEATORIO: " + aleatorio + " -> " + "" + " GANADOR " + b + "\n");
