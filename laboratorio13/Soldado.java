...
public class Soldado {
    ...
    @Override
    public int hashCode(){
        return (""+NivelVida + NivelAtaque + NivelDefensa).hashCode();
    }
    
    public Soldado add (Soldado X){
        Soldado sp = new Soldado();
        sp.setNivelVida(X.vidaActual + this.getVidaActual());
        sp.setNivelAtaque(X.NivelAtaque + this.getNivelAtaque());
        sp.setNivelDefensa(X.NivelDefensa + this.getNivelDefensa());
        return sp;
    }
}
