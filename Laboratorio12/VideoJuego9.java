...
public class VideoJuego9 {
    ...
    private static int num_ejercito1;
    private static int num_ejercito2;
    private static Soldado[][] tablero;
    ...
    //Random
    public static void GeneracionSoldados(){
        num_ejercito1 = r.nextInt(10) + 1;
        num_ejercito2 = r.nextInt(10) + 1;
        generar_HasMap(ejercito1, num_ejercito1, "1");
        generar_HasMap(ejercito2, num_ejercito2, "2");
    ...
    public static void ClonarSoldado(){
        ...
        if (equipo.equals("1")) {
            ...
            String soldado = sc.next();
            if (soldado.equals(ejercito1.values())) {
                 mostrar_Hasmap(ejercito1);
            }
        }
    }
